...
EASVector = [20 25 30 35];
LDVector = [5.47 4.6 3.46 2.7];
...
% put bestEAS and bestLD into aircraftPerformance.m and rerun main.m
figure
plot(bestEAS, altitudeVector)
title('best EAS at each altitude')
xlabel('EAS (m/s)')
ylabel('altitude (m)')


figure
plot(bestLD, altitudeVector)
title('LD corresponding to best EAS given wind')
xlabel('LD')
ylabel('altitude (m)')
